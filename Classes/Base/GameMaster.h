...
#define STS_HIDEWAIT (12.0f / 60.0f)//回避モーションが終了するまでの全体フレーム
#define STS_HIDESTART (1.0f / 60.0f)//回避ボタンを押してから回避モーションが始まるまでの時間
#define STS_MUTEKISTART (0.0f / 60.0f)//回避モーションが始まってから無敵時間に移行するまでの時間
#define STS_APPEARSTART (1.0f / 60.0f)//回避ボタンを離してから突撃モーションが始まるまでの時間
